...
Highcharts.setOptions({
    colors: ['rgba(255,76,64,0.8)','rgba(76,217,100,0.8)','rgba(52,172,220,0.8)','rgba(249,158,30,0.8)','rgba(52,172,220,0.8)']
})
...
$('document').ready(function() {
    $(".sparkline_one").sparkline([8, 6, 5, 6, 7, 5, 4, 5, 6, 9, 8, 7, ], {
        type: 'bar',
        height: '40',
        width: '50px',
        barWidth: 5,
    ...
    $(".sparkline_one2").sparkline([5, 6, 7, 8, 9, 9, 7, 8, 6, ], {
        type: 'bar',
        height: '40',
        width: '50px',
        barWidth: 5,
    ...
    $(".sparkline_three").sparkline([2, 3, 4, 5, 6, 5, 4, 3, 2, 3, 4, 5, 6, 5, 4, 3, 2, 3, 4, 5, 6, 5, 4, 3, 2, 4, 5], {
        type: 'discrete',
        width: 'auto',
        height: '40',
        lineColor: '#0000f0',
