                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="profile_update.php" class="btn btn-light"> Profile
                                        </a>
                                    </div>
                ...
                <aside class="sidebar">
                    <nav class="sidebar-nav" id="sidebarscroll">
                        <ul class="metismenu ripple" id="menu">
									...
									<li class="active">
                                        <a href="contact_us_admin.php">
                                        <span class="sidebar-nav-item-icon fa fa-info-circle fa-fw">
                                        </span>
                                        <span class="aText">ContactUs
                                        </span>                                      
                                        </a>
                                    </li>
									<li class="active">
