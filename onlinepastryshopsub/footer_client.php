        				...
        				<div class="newsletter_form" id="newsletter_form">
							...
							<div class="input-group">
								...
								<div class="input-group-append">
									<button class="button" type="submit" name="subscribe" id="subscribe"><i class="fa fa-send"></i>&nbsp; <span>SUBSCRIBE</span></button>
								</div>
							</div>
        				</div>
        			</div>
        			...
        			<div class="row footer_wd_inner">
        				<div class="col-lg-3 col-6">
        					<aside class="f_widget f_about_widget">
        						...
        						<p tyle="text-align: justify;">Pastry Queen is a home made pastry shop in Surat.Pastry Queen aims to serve the most creative and mouth-watering pastries,to help make your celebration even more special!!</p><a href="about_us.php">READ MORE</a>
        						<ul class="nav">
						...
						$a=2;
						  ...
						  $fetch_company_row=mysql_fetch_array($fetch_company);
        				...
        				<div class="col-lg-3 col-6">
        					<aside class="f_widget f_contact_widget">
        						...
        						<h5>sheiljagandhi603@gmail.com</h5>
        					</aside>
        				</div>
        			</div>
        		</div>
        		...
        		<div class="container">
        			<div class="copyright_inner">
        				<div class="float-left">
        					<h5>© Copyright PastryQueen. All right reserved.</h5>
        				</div>
