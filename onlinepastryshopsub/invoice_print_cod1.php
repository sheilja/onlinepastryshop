               ...
               <table class="table">
                  <tfoot style="font-size: 14px;">
				    <tr>
                      ...
                      <td colspan="1"><?php echo "&#8377; " .number_format($rowData['sub_total'],2); ?> </td>
                    </tr>
					<tr>                      
                      <td colspan="2">GST (Tax incl.)</td>
                      <td colspan="1"><?php echo "&#8377; " .number_format($rowData['GST_total'],2); ?> </td>
                    </tr>
					<tr>					                      
                      <td colspan="2">Shipping Charge</td>
                      <td colspan="1"><?php echo "&#8377; " .number_format($rowData['shipping_cost'],2); ?> </td>
                    </tr> 
					<tr>					                      
                      <td colspan="2">Discount</td>
                      <td colspan="1"><?php echo "&#8377; " .number_format($rowData['discount'],2); ?> </td>
                    </tr> 
				  	<tr> 
                      <td colspan="2"><strong>Total products (tax incl.)</strong></td>
                      <td colspan="1"><strong><?php echo "&#8377; " .number_format(ceil($rowData['final_total']),2); ?> </strong></td>
                    </tr>
