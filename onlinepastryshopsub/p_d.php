<?php 
  ...
  include_once('header_client.php');
   ...
   if(isset($_POST["btnadd"]))
   {
        ...
        $pin_u_q="update user_register set pincode='".$_POST['select_pincode']."' where user_id='".$_SESSION['login_client']."'";
        $pin_u=mysql_query($pin_u_q,$con);		
...
<head>
	...
	var select_pincode=document.getElementById('select_pincode').selectedIndex;
  
	if(select_pincode==0)
	{

		document.getElementById('pin').innerHTML = "Please Select Delivery Pincode";	
        flag=1;	
	}
	else
	{
				...
				<div class="product_details_text">
				   ...
				   <div class="quantity_box">
                       ...
                       <span id="e" class="text-danger" style="float:right;"></span>
                          <input type='date' id="datepicker" name="datepicker" onchange="abc()" style="width: 369px;" />
				   ...
				   <div class="quantity_box">
					...
					<div class="quantity_box">
						<h6>Select Pincode for Delivery</h6>	
                        <span id="pin" class="text-danger" style="float:right;"></span>						
					 <select id="select_pincode" name="select_pincode"  class="col-lg-12" style="height: 30px;">
